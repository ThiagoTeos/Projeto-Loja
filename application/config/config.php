...
|
*/
$config['base_url'] = 'http://localhost/lojteos/';
...
|
*/
//$config['index_page'] = 'index.php'; colocar o nome index.php
$config['index_page'] = '';
...
|
*/
$config['global_xss_filtering'] = TRUE; // camanda de segurança. Filtro para Post, Get ou cookie
...
*/
$config['csrf_protection'] = TRUE; // SEGURANÇA - Não permite a utilização do mesmo POST caso tenha alguma validação
